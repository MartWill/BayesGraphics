...
public class graficoController implements Initializable {
    ...
    public void setDados(List<Double> pegarListValoresVariavelAlvo, List<String> cores, List<String> listaNomesValores) {
        // grafico.getData().clear();

        XYChart.Series serie = new XYChart.Series();
        /*CONFIGURANDO SERIE*/

        for (int i = 0; i < pegarListValoresVariavelAlvo.size(); i++) {
            if (i < cores.size()) {
                serie.getData().add(mostrarValorIndividual(listaNomesValores.get(i), (pegarListValoresVariavelAlvo.get(i)), cores.get(i)));
            } else {
                serie.getData().add(mostrarValorIndividual(listaNomesValores.get(i), (pegarListValoresVariavelAlvo.get(i)), cores.get(i - cores.size())));
            }
        }
