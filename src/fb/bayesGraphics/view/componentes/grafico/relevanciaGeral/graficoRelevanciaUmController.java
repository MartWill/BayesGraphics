 ...
 */
package fb.bayesGraphics.view.componentes.grafico.relevanciaGeral;
 ...
 * @author Maia
 */
public class graficoRelevanciaUmController implements Initializable {
    ...
    private void salvarOneButton(ActionEvent event) throws IOException {
        ...
        fileChooser.setInitialFileName("RelevanciaValores");
    ...
    public void setDados(List<Double> pegandoListaValorProb, String cor) {
        ...
        for (int i = 0; i < pegandoListaValorProb.size(); i++) {
            serie.getData().add(mostrarValorIndividual("NOME " + i, (pegandoListaValorProb.get(i)), cor));
